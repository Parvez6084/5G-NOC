...
type TelemetryServiceClient interface {
	...
	SendTelemetry(ctx context.Context, in *TelemetryReading, opts ...grpc.CallOption) (*TelemetryAck, error)
}
...
func (c *telemetryServiceClient) SendTelemetry(ctx context.Context, in *TelemetryReading, opts ...grpc.CallOption) (*TelemetryAck, error) {
...
type TelemetryServiceServer interface {
	// SendTelemetry sends a single reading and gets back an ack.
	SendTelemetry(context.Context, *TelemetryReading) (*TelemetryAck, error)
...
func (UnimplementedTelemetryServiceServer) SendTelemetry(context.Context, *TelemetryReading) (*TelemetryAck, error) {
...
func _TelemetryService_SendTelemetry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TelemetryServiceServer).SendTelemetry(ctx, req.(*TelemetryReading))
	}
